...
public class DragonShinobi
{
	...
	public void ScriptMain(ScriptInterface bot)
	{
		...
		while (!bot.ShouldExit())
		{
			...
			{
				InvItemFarm("Perfect Orochi Scales", 10, "shadowfortress", "r11", "Bottom", 7924);
				SafeQuestComplete(7924);
			}
		}
		bot.Log($"[{DateTime.Now:HH:mm:ss}] Script stopped successfully.");
		StopBot("Successfully Farmed 300 Dragon Shinobi Token");
	}
	...
	/*
		...
		*   InvItemFarm("ItemName", ItemQuantity, "MapName", "MapNumber", "CellName", "PadName", "MonsterName", QuestID);
		*   TempItemFarm("TempItemName", TempItemQuantity, "MapName", "MapNumber", "CellName", "PadName", "MonsterName", QuestID);
		*   SafeEquip("ItemName");
