...
//Edit your skill order here. Skill No. in RBot = Skill No. in AQW - 1.//
        ...
        bot.RegisterHandler(1, b => {
    		if (bot.Player.InCombat == true) bot.Player.UseSkill(4);
        	if (bot.Player.InCombat == true) bot.Player.UseSkill(3);
        	if (bot.Player.InCombat == true) bot.Player.UseSkill(2);
        	if (bot.Player.InCombat == true) bot.Player.UseSkill(1);
		});
