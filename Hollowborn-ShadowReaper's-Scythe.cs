...
public class Script
{
    ...
    public void ScriptMain(ScriptInterface bot)
    {
        ...
        while (!bot.ShouldExit())
        {
            ...
            while (bot.Player.Gold < 50000000)
            {
                FarmIceStormArena();
            }
            ...
            foreach (var Component in HollowbornComponents)
            {
                if (!bot.Inventory.Contains(Component, 1))
                {
                    ...
                    SafePurchase(Component, 1, "shadowrealm", MapNumber, 1889);
                }
            }
            if (!bot.Inventory.Contains("Hollowborn Reaper's Minion", 1))
            {
                FarmComponentReqs(150, 2020, 2, 0, 0);
                SafePurchase("Hollowborn Reaper's Minion", 1, "shadowrealm", MapNumber, 1889);
            }
    ...
    public void FarmComponentReqs(int HollowSoul, int BoneDust, int DeathsOversight, int GlitchScythe, int UnmouldedEssence)
    {
        ...
        InvItemFarm("Bone Dust", BoneDust, "battleunderb", MapNumber, "Enter", "Spawn");
        InvItemFarm("Death's Oversight", DeathsOversight, "shadowattack", MapNumber, "Boss", "Left");
        InvItemFarm("Incarnation of Glitches Scythe", GlitchScythe, "cathedral", MapNumber, "r14", "Left");
        SafePurchase("Unmoulded Fiend Essence", UnmouldedEssence, "tercessuinotlim", MapNumber, 1951);
    }
